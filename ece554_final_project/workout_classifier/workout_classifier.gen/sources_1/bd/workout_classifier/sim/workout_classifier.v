...
//Date        : Mon Apr 20 20:20:18 2026
//Host        : Madis_ThinkPad running 64-bit major release  (build 9200)
//Command     : generate_target workout_classifier.bd
//Design      : workout_classifier
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "workout_classifier,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=workout_classifier,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "workout_classifier.hwdef" *) 
module workout_classifier
   ();
  ...
  workout_classifier_axi_smc_0 axi_smc
  ...
  workout_classifier_mlp_controller_0_2 mlp_controller_0
       (.s00_axi_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .s00_axi_araddr(axi_smc_M00_AXI_ARADDR),
        .s00_axi_aresetn(rst_ps8_0_96M_peripheral_aresetn),
  ...
  workout_classifier_rst_ps8_0_96M_0 rst_ps8_0_96M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  workout_classifier_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
