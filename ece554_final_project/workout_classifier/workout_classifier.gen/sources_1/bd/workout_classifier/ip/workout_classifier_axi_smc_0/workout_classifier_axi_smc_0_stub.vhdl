...
-- Date        : Mon Apr 20 19:08:37 2026
-- Host        : Madis_ThinkPad running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top workout_classifier_axi_smc_0 -prefix
--               workout_classifier_axi_smc_0_ workout_classifier_axi_smc_0_stub.vhdl
-- Design      : workout_classifier_axi_smc_0
...
entity workout_classifier_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of workout_classifier_axi_smc_0 : entity is "workout_classifier_axi_smc_0,bd_94d0,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of workout_classifier_axi_smc_0 : entity is "workout_classifier_axi_smc_0,bd_94d0,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of workout_classifier_axi_smc_0 : entity is "yes";
end workout_classifier_axi_smc_0;

architecture stub of workout_classifier_axi_smc_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 96968727, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN workout_classifier_zynq_ultra_ps_e_0_0_pl_clk0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_94d0,Vivado 2025.2";
begin
end;
