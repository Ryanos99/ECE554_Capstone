...
// Command     : write_verilog -force -mode synth_stub -rename_top workout_classifier_axi_smc_0 -prefix
//               workout_classifier_axi_smc_0_ workout_classifier_axi_smc_0_stub.v
...
(* CHECK_LICENSE_TYPE = "workout_classifier_axi_smc_0,bd_94d0,{}" *) (* CORE_GENERATION_INFO = "workout_classifier_axi_smc_0,bd_94d0,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_94d0,Vivado 2025.2" *) 
module workout_classifier_axi_smc_0(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
