...
HD_PWD='Z:/ece554_final_project/workout_classifier/workout_classifier.runs/workout_classifier_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log workout_classifier_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source workout_classifier_zynq_ultra_ps_e_0_0.tcl
