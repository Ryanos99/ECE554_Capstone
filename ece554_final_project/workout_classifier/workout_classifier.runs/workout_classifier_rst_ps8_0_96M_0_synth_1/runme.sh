...
HD_PWD='Z:/ece554_final_project/workout_classifier/workout_classifier.runs/workout_classifier_rst_ps8_0_96M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log workout_classifier_rst_ps8_0_96M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source workout_classifier_rst_ps8_0_96M_0.tcl
