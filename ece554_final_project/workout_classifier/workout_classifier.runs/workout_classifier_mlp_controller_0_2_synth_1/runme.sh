...
HD_PWD='Z:/ece554_final_project/workout_classifier/workout_classifier.runs/workout_classifier_mlp_controller_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log workout_classifier_mlp_controller_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source workout_classifier_mlp_controller_0_2.tcl
