...
HD_PWD='Z:/ece554_final_project/workout_classifier/workout_classifier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log workout_classifier_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source workout_classifier_wrapper.tcl
