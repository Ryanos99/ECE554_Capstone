...
HD_PWD='Z:/ece554_final_project/workout_classifier/workout_classifier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log workout_classifier_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source workout_classifier_wrapper.tcl -notrace
